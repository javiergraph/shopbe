    ...
    <tbody>
        ...
        foreach($produits as $produit){
            echo "<tr>";
                ...
                echo "<td><a href='modify.php?edit=".$produit[0]."'><button class='form btn btn-outline-dark btn-block'>Modify</button></a>";
                ...
                echo '<button class="form btn btn-danger btn-block" name="send" type="submit">Delete</button>';
                echo "</form></td>";
            echo "</tr>";
        }
        ?>
