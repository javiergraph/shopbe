...
<head>
    ...
    <body>
        <header>
                <h1 class="nom-site">OPEN DESIGN COURSE</h1>
                <p>OUR STORIES</p>
        </header>

        <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
            <div class="container">
                <a class="navbar-brand" href="index.php">ODC</a>
                ...
                <div class="col-auto" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" href="list-products.php">Gestion Articles</a>
                        <a class="nav-link" href="panier.php">Description</a>
                        <div class="nav-link">
